...
import { getUserBadges, getBadgeProgress } from "@/lib/achievement-badges"

type StatsTab = "overview" | "records" | "muscles" | "badges"

function getInitialTab(tab?: string): StatsTab {
  if (tab === "records" || tab === "muscles" || tab === "badges") {
    return tab
  }
    ...
    <main className="min-h-screen bg-neutral-950 text-white p-6">
      <div className="max-w-2xl mx-auto">
        ...
        <StatsClient
          ...
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          badgeProgress={badgeProgress as any[]}
