      ...
      >
        ...
        >
          ...
          <FitCard accent>
            ...
            <View style={styles.stepInputShell}>
              <TextInput
                value={stepInput}
            ...
            <Pressable
              ...
              disabled={!hasStepChanges || savingStatus === "saving"}
              style={[
                styles.confirmStepsButton,
                (!hasStepChanges || savingStatus === "saving") &&
                  styles.confirmStepsButtonDisabled,
              ]}
            >
              {savingStatus === "saving" ? (
                <ActivityIndicator color={colors.background} />
              ) : (
                <Text style={styles.confirmStepsButtonText}>
                  {hasStepChanges ? "Save Steps" : "Steps Saved"}
                </Text>
              )}
            </Pressable>
...
const styles = StyleSheet.create({
  ...
  confirmStepsButtonDisabled: {
    opacity: 0.55,
  },
  confirmStepsButtonText: {
